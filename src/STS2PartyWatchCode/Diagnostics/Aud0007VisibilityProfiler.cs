...
internal static class Aud0007VisibilityProfiler
{
    ...
    public static void Start()
    {
        try
        {
            ...
            WriteDiagnosticLine(
                "[STS2 Party Watch][AUD-0007] probe=started"
