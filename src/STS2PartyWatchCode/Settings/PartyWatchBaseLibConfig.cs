...
internal sealed class PartyWatchBaseLibConfig : SimpleModConfig
{
    private static readonly string[] PropertyOrder =
    [
        nameof(ConfigLanguage),
        nameof(EnablePartyWatchHud),
        nameof(ShowAdvancedShieldHeartDetails),
        nameof(FreezeHudNumbersAfterTurnEnd),
        nameof(DamageDisplayMode),
        nameof(IncomingDamagePlacement),
        nameof(IncludeCurrentBlockInIncomingDamage),
        nameof(IncludePowerBlockInIncomingDamage),
        nameof(IncludeRelicBlockInIncomingDamage),
        nameof(IncludePowerHpLossModifiersInIncomingDamage),
        nameof(IncludeRelicHpLossModifiersInIncomingDamage),
        nameof(ShowLocalPlayerHudInMultiplayer),
        nameof(HudAnchorPreset),
        nameof(HorizontalOffset),
        nameof(VerticalOffset),
        nameof(TotalExpectedLossColor),
        nameof(ShieldDetailColor),
        nameof(HeartDetailColor)
    ];

    private static PartyWatchBaseLibConfig? _activeConfig;
    private static PartyWatchConfigLanguage _configLanguage;
    ...
    private static PartyWatchHudAnchor _hudAnchorPreset = PartyWatchHudAnchor.HealthBarRight;
    ...
    public static PartyWatchConfigLanguage ConfigLanguage
    {
        get => _configLanguage;
        set
        {
    ...
    public static bool EnablePartyWatchHud { get; set; } = true;
    ...
    public static PartyWatchHudAnchor HudAnchorPreset
    {
    ...
    public override void SetupConfigUI(Control optionContainer)
    {
        ...
        AddProperty(optionContainer, nameof(EnablePartyWatchHud));
    ...
    {
        var property = typeof(PartyWatchBaseLibConfig).GetProperty(
            propertyName,
    ...
    {
        PartyWatchBaseLibTitlePatch.RefreshPageTitle(_optionContainer, ConfigLanguage);

        foreach (var (key, header) in _sectionHeaders)
        {
            SetFirstText(header, PartyWatchConfigText.Section(key, ConfigLanguage));
        }
        ...
        foreach (var propertyName in PropertyOrder)
        {
            ...
            {
                SetFirstTextOutside(row, _settingControls[propertyName], PartyWatchConfigText.Setting(propertyName, ConfigLanguage));
            }
                ...
                && IsDropdownProperty(propertyName))
            {
                ...
                SetFirstText(settingControl, PartyWatchConfigText.EnumValue(propertyName, GetPropertyValue(propertyName), ConfigLanguage));
            }
        }
    }
    ...
    {
        return typeof(PartyWatchBaseLibConfig).GetProperty(
            propertyName,
    ...
    private static void RewriteDropdownItems(NConfigDropdown dropdown, string propertyName)
    {
        ...
        for (var i = 0; i < items.Count; i++)
        {
            ...
            var text = PartyWatchConfigText.EnumValue(propertyName, value, ConfigLanguage);
    ...
    private static bool TryGetDropdownText(string text, out string localized)
    {
        ...
        {
            nameof(PartyWatchConfigLanguage.SimplifiedChinese) => "简体中文",
            nameof(DamageDisplayMode.ExpectedHpLossOnly) => PartyWatchConfigText.EnumValue(nameof(DamageDisplayMode), DamageDisplayMode.ExpectedHpLossOnly, ConfigLanguage),
            nameof(DamageDisplayMode.IncomingDamageOnly) => PartyWatchConfigText.EnumValue(nameof(DamageDisplayMode), DamageDisplayMode.IncomingDamageOnly, ConfigLanguage),
            nameof(DamageDisplayMode.Both) => PartyWatchConfigText.EnumValue(nameof(DamageDisplayMode), DamageDisplayMode.Both, ConfigLanguage),
            nameof(IncomingDamagePlacement.LeftOfExpectedHpLoss) => PartyWatchConfigText.EnumValue(nameof(IncomingDamagePlacement), IncomingDamagePlacement.LeftOfExpectedHpLoss, ConfigLanguage),
            nameof(IncomingDamagePlacement.RightOfExpectedHpLoss) => PartyWatchConfigText.EnumValue(nameof(IncomingDamagePlacement), IncomingDamagePlacement.RightOfExpectedHpLoss, ConfigLanguage),
            nameof(PartyWatchHudAnchor.HealthBarRight) => PartyWatchConfigText.EnumValue(nameof(HudAnchorPreset), PartyWatchHudAnchor.HealthBarRight, ConfigLanguage),
            nameof(PartyWatchHudAnchor.HealthBarLeft) => PartyWatchConfigText.EnumValue(nameof(HudAnchorPreset), PartyWatchHudAnchor.HealthBarLeft, ConfigLanguage),
            nameof(PartyWatchHudAnchor.HealthBarAbove) => PartyWatchConfigText.EnumValue(nameof(HudAnchorPreset), PartyWatchHudAnchor.HealthBarAbove, ConfigLanguage),
            nameof(PartyWatchHudAnchor.HealthBarBelow) => PartyWatchConfigText.EnumValue(nameof(HudAnchorPreset), PartyWatchHudAnchor.HealthBarBelow, ConfigLanguage),
            "Expected HP Loss (Default)" when ConfigLanguage == PartyWatchConfigLanguage.SimplifiedChinese => PartyWatchConfigText.EnumValue(nameof(DamageDisplayMode), DamageDisplayMode.ExpectedHpLossOnly, ConfigLanguage),
            "Incoming Damage" when ConfigLanguage == PartyWatchConfigLanguage.SimplifiedChinese => PartyWatchConfigText.EnumValue(nameof(DamageDisplayMode), DamageDisplayMode.IncomingDamageOnly, ConfigLanguage),
            "Show Both" when ConfigLanguage == PartyWatchConfigLanguage.SimplifiedChinese => PartyWatchConfigText.EnumValue(nameof(DamageDisplayMode), DamageDisplayMode.Both, ConfigLanguage),
            "Left of Expected Loss" when ConfigLanguage == PartyWatchConfigLanguage.SimplifiedChinese => PartyWatchConfigText.EnumValue(nameof(IncomingDamagePlacement), IncomingDamagePlacement.LeftOfExpectedHpLoss, ConfigLanguage),
            "Right of Expected Loss" when ConfigLanguage == PartyWatchConfigLanguage.SimplifiedChinese => PartyWatchConfigText.EnumValue(nameof(IncomingDamagePlacement), IncomingDamagePlacement.RightOfExpectedHpLoss, ConfigLanguage),
            "Right of Health Bar" when ConfigLanguage == PartyWatchConfigLanguage.SimplifiedChinese => PartyWatchConfigText.EnumValue(nameof(HudAnchorPreset), PartyWatchHudAnchor.HealthBarRight, ConfigLanguage),
            "Left of Health Bar" when ConfigLanguage == PartyWatchConfigLanguage.SimplifiedChinese => PartyWatchConfigText.EnumValue(nameof(HudAnchorPreset), PartyWatchHudAnchor.HealthBarLeft, ConfigLanguage),
            "Above Health Bar" when ConfigLanguage == PartyWatchConfigLanguage.SimplifiedChinese => PartyWatchConfigText.EnumValue(nameof(HudAnchorPreset), PartyWatchHudAnchor.HealthBarAbove, ConfigLanguage),
            "Below Health Bar" when ConfigLanguage == PartyWatchConfigLanguage.SimplifiedChinese => PartyWatchConfigText.EnumValue(nameof(HudAnchorPreset), PartyWatchHudAnchor.HealthBarBelow, ConfigLanguage),
            _ => text
        };
