...
internal static class DamageForecastHudVisibilityPolicy
{
    public static bool ShouldRenderHud(NHealthBar bar, Creature creature, out bool temporarilyCovered)
    {
        ...
        if (combatState.Players.Count > 1 && !DamageForecastUiSettings.ShowLocalHudInMultiplayer)
        {
            return false;
        }
