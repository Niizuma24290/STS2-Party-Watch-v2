...
Phase 1A 已完成。Phase 1B 已完成。Phase 5 已完成：攻击 Intent、Burn/DamageVar、第一批 EffectiveBlock 候选均已进入 `🛡 -N` 并完成 Steam 运行时回归验证。Phase 6A 已完成：Beckon / Bad Luck 固定 direct HP loss 已进入 `♥ -N` 并完成 Steam 运行时验证。
